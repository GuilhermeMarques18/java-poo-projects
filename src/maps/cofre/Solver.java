    ...
    public static void main(String[] arg) {
        ...
        while (true) {
            ...
            try {
                ...
                else if (args[0].equals("addCoin"))      { pig.addValuable(Coin.valueOf("C" + args[1])); }
                ...
                else if (args[0].equals("extractCoins")) { println(pig.getCoins());}
                else if (args[0].equals("extractItems")) { println(pig.getItems()); }
